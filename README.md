...
* sample curl:<br>
`$ curl -i -H "Content-Type: application/json" -X POST -d '{"sentence":"heyo, I want to go to San Deigo on January 22 for 2 days"}' http://clemon-olset.ngrok.com/api/1.0/parse`

<h3>routes</h3>
**POST: /api/1.0/parse**
<p>input: sentence structured as a JSON object</p>
*example: `{'sentence':'heyo, I want to go to San Deigo on January 22 for 2 days'}`*
